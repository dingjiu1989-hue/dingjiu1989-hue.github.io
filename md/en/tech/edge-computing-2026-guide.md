...
1. **Near-native speed:** Wasm compiles to machine code at load time and runs at 60-80% of native C++ speed — dramatically faster than interpreted JavaScript.
...
1. **Geo-aware routing** using `request.cf` — an edge-only capability.
