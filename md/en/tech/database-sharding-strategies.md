...
**See also:** [Event-Driven Architecture Patterns: Kafka, RabbitMQ, SQS, and EventBridge Compared](</en/tech/event-driven-architecture-guide.html>), [Database Indexing Strategies: B-Tree, Hash, GIN, GiST, and BRIN Explained](</en/tech/database-indexing-guide.html>), [CSS Container Queries Guide: Component-Based Responsive Design Without Media Queries](</en/tech/css-container-queries-guide.html>)
