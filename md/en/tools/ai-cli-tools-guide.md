...
1. **Open a streaming connection** to the LLM API.
...
1. **Input:** Arguments, flags, stdin, or interactive? What's the primary interface?
...
See also: [Click vs Typer vs argparse](</en/compare/python-cli-frameworks.html>), [Best Terminal Emulators 2026](</en/tools/best-terminal-emulators.html>), [Best Local Dev Tools](</en/tools/best-local-dev-tools.html>).
