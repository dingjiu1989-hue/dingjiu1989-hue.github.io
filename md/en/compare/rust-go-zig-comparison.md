...
- **Async complexity**: `Pin<Box<dyn Future>>`, executor selection, `Send`/`Sync` bounds
...
1. **C/C++ replacement**: Companies migrating legacy C/C++ codebases to a modern language
