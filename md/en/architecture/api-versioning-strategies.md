...
**See also:** [API Gateway vs Service Mesh](</en/architecture/gateway-vs-mesh.html>), [Graceful Shutdown Patterns](</en/architecture/graceful-shutdown.html>), [Leader Election in Distributed Systems](</en/architecture/leader-election.html>)
