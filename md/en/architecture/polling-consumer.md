...
**See also:** [Event Notification vs Event-Carried State Transfer](</en/architecture/event-notification-vs-event-carrying.html>), [Event-Driven Architecture](</en/architecture/event-driven-arch.html>), [Event Collaboration: Choreography vs Orchestration](</en/architecture/event-collaboration.html>).
