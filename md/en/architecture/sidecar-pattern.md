...
**See also:** [Event-Carried State Transfer Pattern](</en/architecture/event-carried-state-transfer.html>), [Contract Testing for Microservices](</en/architecture/contract-testing.html>), [API Composition Pattern](</en/architecture/api-composition-pattern.html>).
