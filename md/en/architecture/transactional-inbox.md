...
**See also:** [Priority Queue Pattern for Message Processing](</en/architecture/priority-queue.html>), [Routing Slip Pattern for Dynamic Message Processing](</en/architecture/routing-slip.html>), [Transactional Outbox Pattern](</en/architecture/transaction-outbox-reliable.html>).
