...
**See also:** [Priority Queue Pattern for Message Processing](</en/architecture/priority-queue.html>), [Request-Reply Pattern for Asynchronous Communication](</en/architecture/request-reply-pattern.html>), [API Composition and Aggregation](</en/architecture/api-composition.html>).
