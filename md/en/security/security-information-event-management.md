...
**See also:** [EDR: Endpoint Detection and Response Solutions](</en/security/endpoint-detection-response.html>), [Endpoint Security](</en/security/endpoint-security.html>), [Cloud Security Posture Management](</en/security/cloud-security-posture.html>).
