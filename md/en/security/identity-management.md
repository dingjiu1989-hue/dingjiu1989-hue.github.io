...
1. **Identity Provider (IdP)**: The authoritative source for user identities. Examples: Okta, Azure AD, Keycloak, Google Workspace.
...
1. User attempts to access an SP resource.
...
# User is redirected to: auth_url?response_type=code&client_id=...
...
1. A request with a business justification.
