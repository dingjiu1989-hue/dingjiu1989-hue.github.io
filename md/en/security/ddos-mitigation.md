...
**See also:** [API Security: Protecting Your REST and GraphQL APIs](</en/security/api-security-guide.html>), [Secure API Design Principles](</en/security/secure-api-design.html>), [Data Classification](</en/security/data-classification.html>).
