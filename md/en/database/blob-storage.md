...
**See also:** [Document Databases: MongoDB, CouchDB, Firestore](</en/database/document-databases.html>), [Database Backup Strategies to Object Storage](</en/database/database-backup-to-s3.html>), [Graph Queries in SQL: Recursive CTEs, Adjacency Lists, and WITH RECURSIVE](</en/database/graph-queries.html>).
