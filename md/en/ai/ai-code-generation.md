...
1. **Generate a skeleton**: Get the function signature and basic structure
...
1. **Check for hallucinations**: AI may use non-existent libraries, functions, or API endpoints
...
1. **Over-reliance without review**: Treating generated code as correct without verification
