...
---|---|---|---  
1. Reconnaissance| Map application functionality, tool access, data sources| Manual review, API exploration| 1-2 days  
...
1. Input delimiters and input validation (blocks ~60% of naive attacks)
...
See also: [Prompt Injection Prevention](</en/ai/prompt-injection-prevention.html>), [AI Agents Guide](</en/ai/ai-agents-guide.html>), [Building RAG From Scratch](</en/ai/building-rag-from-scratch.html>), and [Web Security Basics](</en/tech/web-security-basics.html>).
