...
date: 2026-05-07
board: tech
url: https://dingjiu1989-hue.github.io/tech/docker-quickstart.html
---

# Docker 30 分钟入门：从安装到第一个容器

Docker 是现代开发者的必备技能。这篇文章用最通俗的语言带你 30 分钟上手。
...
macOS 用户推荐 [OrbStack](<https://orbstack.dev/>)（轻量替代 Docker Desktop），或直接 `brew install docker`。Windows/Linux 用户去 docker.com 下载即可。
